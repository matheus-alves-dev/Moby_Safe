...
import 'package:moby_safe/Pages/classificacao_via_page.dart';
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _item(
                  label: 'Coordenadas geográficas (final):',
                  value: coordInicio,
                  onEdit: () {
                    _editarTexto(
                      titulo: 'Coordenadas geográficas (final)',
                ...
                SizedBox(
                  ...
                  child: FilledButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => const ClassificacaoViaPage()),
                      );
                    },
